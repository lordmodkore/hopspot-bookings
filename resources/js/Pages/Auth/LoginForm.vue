        ...
        <div class="flex justify-between items-center mb-4">
            <div class="flex items-center">
                ...
                <label for="remember_me" class="flex items-center cursor-pointer">
                    <div class="relative">
                        <div
                            class="w-10 h-5 rounded-full shadow-inner transition-colors duration-200 ease-in-out"
                            :class="form.remember_me ? 'bg-blue-600' : 'bg-gray-300'"
                        ></div>
                        <div
                            class="dot absolute w-5 h-5 bg-white rounded-full shadow transition-transform duration-200 ease-in-out"
                            :class="{'translate-x-5': form.remember_me, 'translate-x-0': !form.remember_me}"
                        ></div>
                    </div>
                    <span class="ml-3 text-gray-600">Remember this Device</span>
                </label>
            </div>
